   ...
   <div className="bg-gray-100 font-inter text-gray-700">
      <div className="container">
        ...
        <div className="flex flex-row">
          <div
            className="flex flex-col items-center md:w-3/12 lg:w-3/12 sm:w-6/12 w-full text-center bg-green-200 hover:bg-green-300"
          >
            <a
              href="https://sankalptaru.org/location/"
              className="icon-box mt-7 bg-st-green rounded-20 shadow-st-box"
            >
