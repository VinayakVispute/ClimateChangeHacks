    ...
    <section className="font-inter">
      <div className="container">
        ...
        <div className="flex flex-row justify-center">
          <div
            className="flex flex-col items-center w-52 md:w-56 lg:w-56 sm:w-36 bg-green-200 hover:bg-green-300"
          >
          ...
          >
            <div className="bg-fund-utilization mt-7 rounded-2xl h-56 md:h-64">
              ...
              <p className="font-inter text-black text-base">R&amp;D activities</p>
            </div>
          </div>
