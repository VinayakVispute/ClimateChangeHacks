...
function Payment({ trees, carbonFootprint }) {
          ...
          <div className="lg:text-center">
            ...
            <p className="relative mt-4 max-w-2xl text-xl text-white lg:mx-auto">
              <span
                ...
                style={{
                  backgroundImage:
                    "url(https://cdn.pixabay.com/photo/2016/04/01/10/00/tree-1296866_960_720.png)",
                }}
              ></span>
              It takes{" "}
              <span className="text-indigo-600" id="carbon-trees"></span> trees
              to offset your annual footprint. On average, every tree absorbs
              0.07 tons of CO2 annually.
            </p>
          </div>
        </div>
      </div>
      <div className="px-8 py-16">
        <div className="max-w-4xl mx-auto">
          <div className="purchase-offsets">
            <p className="title text-white font-semibold text-xl my-4">
              Offset Now
            </p>
            ...
            <div className="flex flex-col justify-ceter ">
              <div className="slider flex justify-between items-center">
                ...
                />
                <output className="text-3xl ml-8 mr-4">
                  <span className="text-white font-bold">Max:</span>
                  <span className="text-green-500 font-bold px-2">{trees}</span>
                </output>
              </div>
              <a
                href="/Card"
                className="bg-indigo-600 text-white rounded-full px-16 py-4 my-4 w-[30%] mx-auto"
                id="submit"
              >
                Offset Footprint
              </a>
