...
const Card = () => {
 ...
 Astrology relates Guava as the birth tree of Scorpions, signifying vitality and creativity, similar to their character traits. So, did you know? Guava is a rich source of Vitamin C, antioxidants, potassium and fiber. Known as the powerhouse of nutrients.
  ...
  const urls = [
    "https://s3-ap-south-1.amazonaws.com/sankalptaru-web/wp-content/uploads/2022/10/04054134/HM1v-1664528454-500x500.jpg",
  ...
  return (
    <>
      {submit ? (
        <Description Descriptions={Descriptions} url={url} />
      ) : (
        <>
          <section class="flex flex-row gap-x-10 items-center justify-center my-8">
            <div class="max-w-md w-full bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div class="py-4 px-6">
                ...
                <p class="text-gray-700 text-base">
                  Undertaking tree plantation for the farmers in the Rural areas
                  of Jharkhand. Project Hariyar Jharkhand aims to provide
                  livelihood support through agroforestry to these farmers so
                  that they can see the hope for a better future for themselves
                  and their families.
                </p>
            ...
            <div class="max-w-md w-full bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div class="py-4 px-6">
                ...
                <p class="text-gray-700 text-base">
                  Plant trees and claim your #TaxFreeTree today! We are
                  registered under 80G and every tree you plant with us gets you
                  a 50% rebate on the donated amount. Plant to save your taxes
                  while being a helping hand to our farmers and the environment
                </p>
                <div class="flex justify-between items-center mt-4">
            ...
            <div class="max-w-md w-full bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div class="py-4 px-6">
                ...
                <p class="text-gray-700 text-base">
                  ...
                  Astrology relates Guava as the birth tree of Scorpions,
                  signifying vitality and creativity, similar to their character
                  traits. So, did you know? Guava is a rich source of Vitamin C,
                  antioxidants, potassium and fiber. Known as the powerhouse of
                  nutrients.
                </p>
                <div class="flex justify-between items-center mt-4">
          ...
          <section class="flex flex-row gap-x-10 items-center justify-center my-8">
            <div class="max-w-md w-full bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div class="py-4 px-6">
                ...
                <p class="text-gray-700 text-base">
                  Plant trees to protect the environment, it’s our only ray of
                  light! Air Pollution is the contamination of indoor or outdoor
                  environments by an external agent, which turns out to be
                  detrimental to the health of humans and other living
                  organisms. One major benefit of reducing air pollution would
                  be to substantially reduce the chances of diseases in humans,
                  global warming, acid rain, ozone layer depletion and its
                  effects on animals.
                </p>
                <div class="flex justify-between items-center mt-4">
                  <p class="text-gray-600 text-sm">Contribution ₹175.00</p>
